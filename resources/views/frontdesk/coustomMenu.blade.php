        ...
        $(document).ready(function () {
            if ($("#test").addEventListener) {
                ...
                $('body').on('contextmenu', '.guest_cell', function () {
                    ...
                    $('#order_id').val(id[1]);
                    $('#order_room').text(splic_num[1]);
                    $('#order_guest').text(id[2]);
                    $("#link_href").attr('href', "{{url('user/frontdesk')}}"+'/'+"guest/checkout/" + guest_id+"/" + splic_num[1]);
                    $("#recheckin").attr('href', "{{url('user/frontdesk')}}"+'/'+"guest/recheckin/" + guest_id+"/" + splic_num[1]);
                    document.getElementById("rmenu").className = "showcontext";
                    document.getElementById("rmenu").style.top = mouseY(event) + 'px';
                    document.getElementById("rmenu").style.left = mouseX(event) + 'px';
                    window.event.returnValue = false;
...
<div class="hide list-group" id="rmenu">
    ...
    <a onclick="$('#checkInForm').show();" class="pointer list-group-item list-group-item-action">ဧည့်၀င်</a>
    <a onclick="$('#order_form').show();" id="" class="pointer list-group-item list-group-item-action">အော်ဒါမှာရန် </a>
    <a onclick="$('#payment_form').show();"  class="pointer list-group-item list-group-item-action">ငွေပေးချေရန် </a>
    <a href="" id="link_href" class="pointer list-group-item list-group-item-action">ဧည့်ထွက်</a>
    <a href="" id="recheckin" class="pointer list-group-item list-group-item-action">ပယ်ဖျက်ရန်</a>
</div>
...
<div class="hide list-group" id="rmenu1">
    ...
    <a href="" id="cancle" class="pointer list-group-item list-group-item-action">ဖျက်ရန်</a>
</div>

<div class="hide list-group" id="number">
    <li class="list-group-item">သန့်ရှင်းရေးများ</li>
    @php($count_user=0)
...
<div class="hide" id="reservation_form">
    <div class="row reservation_class">
        <div class="card card-body col-md-4 container form-width">
            ...
            <legend>အခန်းကြိုယူရန် ဖောင်</legend>
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="number" name="phone" placeholder="ဖုန်းနံပါတ်..." id="" class="form-control">
                    </div>
                </div>
                ...
                <input type="button" onclick="hideReserv()" value="ပိတ်မည်"
